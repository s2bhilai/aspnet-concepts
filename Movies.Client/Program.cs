...
using IHost host = Host.CreateDefaultBuilder(args)
    ...
    { 
        ...
        //Registers with transient scope
        //When MoviesAPIClient requested from DI system, factory will inject HttpClient
        services.AddHttpClient<MoviesAPIClient>(options =>
        {
